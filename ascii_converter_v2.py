#!/usr/bin/env python3
"""
TheiaVision - Convertisseur ASCII v0.2 (10 niveaux)
Plus de détails, plus de nuances !
"""
...
def image_to_ascii(image_path, output_width=64, output_height=36):
    """Convertit une image en ASCII art avec 10 niveaux de gris."""
    
    # 10 niveaux de densité pour plus de détails
    ...
    for y in range(output_height):
        ...
        for x in range(output_width):
            ...
            # Mapper vers un caractère (0-255 → 0-9)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 ascii_converter_v2.py <image.jpg> [width] [height]")
        sys.exit(1)
